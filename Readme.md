...
# Configuration Script – mSand - Rev. A

This **Configuration** script is designed for the **mSand** model in **Gear Studio**, part of the [Cloud Studio](https://www.cloud.studio/) platform.
...
# Script de Configuration – mSand Rev. A

Este script de **Configuration** está diseñado para el modelo **mSand** en **Gear Studio**, parte de la plataforma [Cloud Studio](https://www.cloud.studio/).
